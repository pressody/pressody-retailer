...
class ComposerClient implements Client {
	...
	protected function getDynamicConfig( array $args ): array {
		...
		return apply_filters( 'pixelgradelt_retailer_composer_client_config', $config, $args );
	}
	...
	protected function parseDynamicConfigArgs( array $config, array $args ): array {
		...
		return apply_filters( 'pixelgradelt_retailer_composer_client_config_parse_args', $config, $args, $originalConfig );
	}
	...
	public function getDefaultDynamicConfig(): array {
		...
		return apply_filters( 'pixelgradelt_retailer_composer_client_default_config', $default_config );
	}
