...
final class Logger extends BaseIO {
	...
	public function __construct( string $minimum_level, array $handlers = null ) {
		...
		if ( null === $handlers ) {
			$handlers = apply_filters( 'pixelgradelt_retailer_register_log_handlers', array() );
		}
	...
	public function log( $level, $message, array $context = [] ) {
		...
		$message   = apply_filters( 'pixelgradelt_retailer_logger_log_message', $message, $level, $context );
	...
	public function clear_expired_logs() {
		$days      = absint( apply_filters( 'pixelgradelt_retailer_logger_days_to_retain_logs', 30 ) );
