...
class RewriteRules extends AbstractHookProvider {
	...
	public function register_query_vars( array $vars ): array {
		$vars[] = 'pixelgradelt_retailer_params';
		$vars[] = 'pixelgradelt_retailer_route';
		return $vars;
	}
	...
	public function maybe_flush_rewrite_rules() {
		if ( is_network_admin() || 'no' === get_option( 'pixelgradelt_retailer_flush_rewrite_rules' ) ) {
			return;
		}

		update_option( 'pixelgradelt_retailer_flush_rewrite_rules', 'no' );
		flush_rewrite_rules();
	}
}
