...
class ApiKeyAjax extends AbstractHookProvider {
	...
	public function register_hooks() {
		add_action( 'wp_ajax_pixelgradelt_retailer_create_api_key', [ $this, 'create_api_key' ] );
		add_action( 'wp_ajax_pixelgradelt_retailer_delete_api_key', [ $this, 'delete_api_key' ] );
	}
