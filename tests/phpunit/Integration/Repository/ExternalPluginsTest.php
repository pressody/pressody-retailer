...
class ExternalPluginsTest extends TestCase {
	...
	public static function wpSetUpBeforeClass( $factory ) {
		...
		$package_type = get_term_by( 'slug', SolutionTypes::PLUGIN, self::$old_container['package.manager']::PACKAGE_TYPE_TAXONOMY );
	...
	public function test_get_non_existent_plugin() {
		/** @var \PixelgradeLT\Retailer\Repository\CachedRepository $repository */
