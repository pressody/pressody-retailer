...
namespace PixelgradeLT\Retailer\Tests\Integration\PackageType;
...
class LocalThemeTest extends TestCase {
	...
	public function setUp(): void {
		...
		register_theme_directory( PIXELGRADELT_RETAILER_TESTS_DIR . '/Fixture/wp-content/themes' );
	...
	public function test_get_theme_from_slug() {
		...
		$package = $this->factory->create( SolutionTypes::THEME, 'local.theme' )
		                         ->from_slug( 'ovation' )
		                         ->build();
