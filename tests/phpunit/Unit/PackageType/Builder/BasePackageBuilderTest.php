...
class BasePackageBuilderTest extends TestCase {
	...
	public function setUp(): void {
		...
		$this->builder = new BaseSolutionBuilder( $package, $package_manager, $release_manager, $archiver, $logger );
	}
	...
	public function test_from_package_data() {
		...
		$expected['slug']                 = 'slug';
		$expected['type']                 = SolutionTypes::PLUGIN;
	...
	public function test_from_package_data_do_not_overwrite() {
		...
		$expected->type                 = SolutionTypes::THEME;
		...
		$package_data['type']                 = SolutionTypes::PLUGIN;
