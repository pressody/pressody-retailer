...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a href="#pixelgradelt_retailer-packages" class="nav-tab"><?php esc_html_e( 'Packages', 'pixelgradelt_retailer' ); ?></a>
	...
	<div id="pixelgradelt_retailer-packages" class="pixelgradelt_retailer-tab-panel">
